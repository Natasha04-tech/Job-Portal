...
function JobCard({ job }) {
    _s();
    const { mutate: applyJob, isPending } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$customHooks$2f$useJobApplication$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useApplyJob"])();
    const handleApply = ()=>{
        applyJob(job.job.id.toString(), {
            onSuccess: (res)=>{
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success(res.message || "✅ Successfully applied for job!");
            },
            onError: ()=>{
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("❌ Failed to apply — you may have already applied.");
            }
        });
    };
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(JobCard, "YJZzGS50I3svjCOTuAj9zIvJuYA=", false, function() {
    return [
...
//# sourceMappingURL=_e46354a2._.js.map