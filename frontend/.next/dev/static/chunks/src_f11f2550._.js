...
const loginUser = async (data)=>{
    const res = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$axiosInstance$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post("/auth/login", data);
    return res.data;
};
const signupUser = async (data)=>{
    const res = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$axiosInstance$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post("/auth/signup", data);
    return res.data;
};
const useLogin = ()=>{
    _s();
...
_s1(useSignup, "wwwtpB20p0aLiHIvSy5P98MwIUg=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useMutation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMutation"]
    ];
});
...
//# sourceMappingURL=src_f11f2550._.js.map