...
const loginUser = async (data)=>{
    const res = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$axiosInstance$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post("/auth/login", data);
    return res.data;
};
const signupUser = async (data)=>{
    const res = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$axiosInstance$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post("/auth/signup", data);
    return res.data;
};
const useLogin = ()=>{
...
//# sourceMappingURL=%5Broot-of-the-server%5D__68335026._.js.map